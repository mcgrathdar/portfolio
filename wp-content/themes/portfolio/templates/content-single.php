...
<div class="row work"> 
    <div class="col-md-4 col-md-push-8 col-xl-push-8 col-xs-12">       
      <p>
    ...
    <div class="col-md-8 col-md-pull-4 col-xl-pull-3 col-xs-12">
        <?php the_content(); ?>
    </div>   
</div>
...
<div class="row work">
  ...
  <div class="col-md-6 col-md-push-6 col-xl-6 col-xl-push-6 col-xs-12 col-height"> 
    <img src="<?php echo $image_three['sizes']['large']; ?>" alt="<?php echo $image_three['alt']; ?>" />
  </div>

  <div class="col-md-6 col-md-pull-6 col-xl-6 col-xl-pull-6 col-xs-12 col-height"> 
